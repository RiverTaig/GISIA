...
// var CACHE_NAME = "GISIA-cache-v1.219";
// var urlsToCache = [
//     "/GISIA/",
//     "/GISIA/index.html",
//     "/GISIA/sw.js",
...
//     "/GISIA/resources/tpk/palmsprings1-18.zip",
...
// // swParam = url.searchParams.get("sw");
// // if (!swParam) {
...
//                     if (fetchRequest.url.indexOf("/gisia/") > -1) {
//                         var original = fetchRequest.url;
//                         fetchRequest.url = fetchRequest.url.replace("/gisia/", "GISIA");
//                         console.log(`MODIFIED URL: old ${original} new ${fetchRequest.url}`);
//                     }
